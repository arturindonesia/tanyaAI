...
@section('user-content')
            ...
            <div class="wsus__banner_overlay">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            <form method="GET" action="{{ route('listings') }}#listing_grid">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-6">
                                        <div class="wsus__search_area">
                                            <button type="submit"
                                                class="read_btn">{{ $websiteLang->where('id', 4)->first()->custom_text }}</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="row">
                        ...
                        @foreach ($listingCategories as $index => $category)
                            ...
                            <div class="col-xl-2 col-sm-6 col-md-4">
                                <a href="{{ route('listings', ['category_slug' => $category->slug, 'page_type' => 'list_view']) }}#listing_grid"
                                    class="wsus__category_single_slider {{ $color }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 m-auto">
                            <div class="wsus__counter_top_video">
                                ...
                                <img src="https://img.youtube.com/vi/{{ $video_id[1] }}/0.jpg" alt="img"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 text-center">
                            <a href="{{ route('listing.category') }}"
                                class="read_btn">{{ $websiteLang->where('id', 5)->first()->custom_text }}</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    @if ($location_section->show_homepage == 1)
        <section id="wsus__location"
            style="background-image:url({{ $bannerImages->where('id', 13)->first()->image ? asset($bannerImages->where('id', 19)->first()->image) : '' }});">
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <div class="wsus__location_filter">
                                <button class="active"
                                    data-filter="*">{{ $websiteLang->where('id', 6)->first()->custom_text }}</button>
                        ...
                        @foreach ($locations as $index => $location)
                            ...
                            <div class="col-xl-4 col-sm-6 {{ $location->id }}">
                                <a href="{{ route('listings', ['location_slug' => $location->slug, 'page_type' => 'list_view']) }}""
                                    class="wsus__single_location">
                                    <img src="{{ $location->image ? asset($location->image) : '' }}" alt="location"
                                        class="img-fluid w-100">
    ...
    @if ($listing_section->show_homepage == 1)
                            ...
                            <div class="col-xl-2">
                                <div class="wsus__featured_single">
                                    <a class="list_images" href="{{ route('listing.show', $listing->slug) }}">
                                        <img src="{{ asset($listing->thumbnail_image) }}" alt="images"
                                            class="img-fluid w-100">
                                    </a>
                                    @guest
                                        <span class="love"><a data-bs-toggle="modal" data-bs-target="#exampleModal"
                                                href="javascript::void"><i class="fas fa-heart"></i></a></span>
                                    @else
                                        <span class="love"><a href="{{ route('user.add.to.wishlist', $listing->id) }}"><i
                                                    class="fas fa-heart"></i></a></span>
                                    @endguest

                                    <a class="map" data-bs-toggle="modal"
                                        data-bs-target="#listngPopUp-{{ $listing->id }}" href="javascript::void"><i
                                            class="fal fas fa-eye"></i></a>

                                    <div class="wsus__featured_single_text">

                                        <span class="small_text {{ $color }}"><a
                                                href="{{ route('listings', ['category_slug' => $listing->listingCategory->slug, 'page_type' => 'list_view']) }}">{{ $listing->listingCategory->name }}</a></span>
        ...
        @foreach ($listings as $index => $listing)
            <section id="wsus__map_popup">
                <div class="modal fade" id="listngPopUp-{{ $listing->id }}" tabindex="-1"
                                ...
                                <div class="row">
                                    <div class="col-12 col-xl-12 col-md-12">
                                        <div class="map_popup_content">
                                            <img src="{{ $listing->thumbnail_image ? asset($listing->thumbnail_image) : '' }}"
                                                alt="images" class="img-fluid w-100">
                                            <div class="map_popup_text">
                                                @if ($listing->is_featured == 1)
                                                    <span><i class="far fa-star"></i>
                                                        {{ $websiteLang->where('id', 10)->first()->custom_text }}</span>
                                                @endif

                                                @if ($listing->verified)
                                                    <span class="red"><i class="far fa-check"></i>
                                                        {{ $websiteLang->where('id', 11)->first()->custom_text }}</span>
                                                @endif
                                                <h5>{{ $listing->title }}</h5>

                                                @if ($listing->phone)
                                                    <a class="call" href="callto:{{ $listing->phone }}"><i
                                                            class="fal fa-phone-alt"></i> {{ $listing->phone }}</a>
                                                @endif
                                                @if ($listing->email)
                                                    <a class="mail" href="mailto:{{ $listing->email }}"><i
                                                            class="fal fa-envelope"></i> {{ $listing->email }}</a>
                                                @endif

                                                <p>{{ $listing->sort_description }}</p>
                                                <a class="read_btn"
                                                    href="{{ route('listing.show', $listing->slug) }}">{{ $websiteLang->where('id', 12)->first()->custom_text }}</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-xl-12 col-md-12">
    ...
    @if ($listing_package_section->show_homepage == 1)
        <section id="wsus__package"
            style="background-image:url({{ $bannerImages->where('id', 20)->first()->image ? asset($bannerImages->where('id', 13)->first()->image) : '' }});">
                            ...
                            @foreach ($listingPackages as $index => $listingPackage)
                                ...
                                <div class="col-xl-4 col-sm-6 col-lg-4">
                                    <div class="member_price">
                                        ...
                                        <span>{{ $listingPackage->number_of_days == -1 ? $unlimited : $listingPackage->number_of_days }}
                                            {{ $websiteLang->where('id', 14)->first()->custom_text }}</span>


                                        <p>{{ $listingPackage->number_of_listing == -1 ? $unlimited : $listingPackage->number_of_listing }}
                                            {{ $websiteLang->where('id', 15)->first()->custom_text }}</p>

                                        @if ($listingPackage->number_of_days != -1)
                                            <p>{{ $listingPackage->number_of_days }}
                                                {{ $websiteLang->where('id', 16)->first()->custom_text }}</p>
                                        @else
                                            <p>{{ $unlimited }}
                                                {{ $websiteLang->where('id', 16)->first()->custom_text }}</p>
                                        @endif
                                        ...
                                        <p>{{ $listingPackage->number_of_aminities == -1 ? $unlimited : $listingPackage->number_of_aminities }}
                                            {{ $websiteLang->where('id', 17)->first()->custom_text }}</p>


                                        <p>{{ $listingPackage->number_of_photo == -1 ? $unlimited : $listingPackage->number_of_photo }}
                                            {{ $websiteLang->where('id', 18)->first()->custom_text }}</p>
                                        <p>{{ $listingPackage->number_of_video == -1 ? $unlimited : $listingPackage->number_of_video }}
                                            {{ $websiteLang->where('id', 19)->first()->custom_text }}</p>
                                        @if ($listingPackage->is_featured == 1)
                                            <p>{{ $websiteLang->where('id', 20)->first()->custom_text }}</p>
                                            <p>{{ $listingPackage->number_of_feature_listing == -1 ? $unlimited : $listingPackage->number_of_feature_listing }}
                                                {{ $websiteLang->where('id', 21)->first()->custom_text }}</p>
                                        @else
                                        ...
                                        @auth
                                            @if ($listingPackage->package_type == 0)
                                                <a href="javascript:void(0)" class="EnrollBtn"
                                                    data-id="{{ $listingPackage->id }}">{{ $websiteLang->where('id', 13)->first()->custom_text }}</a>
                                            @else
                                                <a
                                                    href="{{ route('user.purchase.package', $listingPackage->id) }}">{{ $websiteLang->where('id', 13)->first()->custom_text }}</a>
                                            @endif
                                        @else
                                            <a data-bs-toggle="modal" data-bs-target="#exampleModal"
                                                href="javascript::void">{{ $websiteLang->where('id', 13)->first()->custom_text }}</a>
                                @endif
                            </div>
                        </div>
        @endforeach
                                ...
                                <div class="col-xl-4 col-sm-12 col-md-6 col-lg-4">
                                    <div class="single_blog">
                                        <a href="{{ route('blog.details', $blog->slug) }}"><img
                                                ...
                                                alt="bloh images" class="img-fluid w-100"></a>
                                        ...
                                        <a class="read_btn"
                                            href="{{ route('blog.details', $blog->slug) }}">{{ $websiteLang->where('id', 484)->first()->custom_text }}
        ...
        @if ($testimonial_section->show_homepage == 1)
            <section id="wsus__testimonial"
                style="background-image:url({{ $bannerImages->where('id', 20)->first()->image ? asset($bannerImages->where('id', 21)->first()->image) : '' }});">
                            ...
                            @foreach ($testimonials as $testimonial)
                                <div class="col-xl-6">
                                    <div class="wsus__single_clients">
                                        <p><i class="fal fa-quote-left" id="top_icon"></i> {{ $testimonial->description }}
                                        </p>
